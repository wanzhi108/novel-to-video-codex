...
class CodeSnippet(BaseTool):
    ...
    def execute(self, inputs: dict[str, Any]) -> ToolResult:
        ...
        # Use Pygments ImageFormatter for rendering. On some Windows setups
        # the registry lookup fails even when the font is installed, so fall
        # back to an explicit font file path.
        try:
            ...
            font_path = self._find_monospace_font()
    ...
    def _find_monospace_font() -> str | None:
        ...
        for name in ("consola.ttf", "cour.ttf", "CascadiaMono.ttf"):
